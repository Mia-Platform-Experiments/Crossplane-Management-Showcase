# Crossplane Management Showcase Configurations

This repository contains all the configuration resources required for the Crossplane Management Showcase project to function properly and expose its business features.
